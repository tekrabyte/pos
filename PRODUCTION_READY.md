...
APP_ENV=production
APP_DEBUG=false
APP_URL=https://just-run-1.preview.emergentagent.com
...
### 2. Frontend .env
```env
REACT_APP_BACKEND_URL=https://just-run-1.preview.emergentagent.com
```
...
### Base URL
- **Production**: `https://just-run-1.preview.emergentagent.com/api`
...
### Access URLs:
- **Backend API**: `https://just-run-1.preview.emergentagent.com/api`
- **Frontend**: `https://just-run-1.preview.emergentagent.com`
- **Health Check**: `https://just-run-1.preview.emergentagent.com/api/health`
